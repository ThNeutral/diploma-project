...
export class MetadataService {
  public constructor(private client: HttpClientWrapper) {}
  ...
  private inputSize$: Observable<[number, number, number, number]> | null = null;
  public getInputSize(): Observable<[number, number, number, number]> {
    if (!this.inputSize$) {
